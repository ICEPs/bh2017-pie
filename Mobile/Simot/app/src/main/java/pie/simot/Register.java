...
public class Register extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText orgNameT = (EditText)findViewById(R.id.name);
        final EditText passwordT = (EditText)findViewById(R.id.password);
        final EditText confirmPasswordT = (EditText)findViewById(R.id.confirmPassword);
        final AutoCompleteTextView addressT = (AutoCompleteTextView)findViewById(R.id.address);
        final EditText repNameT = (EditText)findViewById(R.id.representativeName);
        final EditText contactInfoT = (EditText)findViewById(R.id.contactInfo);
        final EditText orgDescT = (EditText)findViewById(R.id.orgDescription);
...
//                        Log.e("GeoData", parseData(place.getLatLng() + ""));
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!(orgName.isEmpty() || password.isEmpty() || confirmPassword.isEmpty() || address.isEmpty() ||
                        repName.isEmpty() || contactInfo.isEmpty() || orgDesc.isEmpty())) {
                    ...
                    Toast.makeText(getApplicationContext(), "Please fill in the missing fields", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
